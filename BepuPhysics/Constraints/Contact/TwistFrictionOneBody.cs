...
namespace BepuPhysics.Constraints.Contact
{
    ...
    public static class TwistFrictionOneBody
    {
        ...
        public static void ApplyImpulse(in Vector3Wide angularJacobianA, in BodyInertiaWide inertiaA,
            in Vector<Number> correctiveImpulse, ref BodyVelocityWide wsvA)
        {
        ...
        public static void ComputeCorrectiveImpulse(in Vector3Wide angularJacobianA, in Vector<Number> effectiveMass,
            in BodyVelocityWide wsvA, in Vector<Number> maximumImpulse,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void WarmStart(in Vector3Wide angularJacobianA, in BodyInertiaWide inertiaA, in Vector<Number> accumulatedImpulse, ref BodyVelocityWide wsvA)
        {
            ApplyImpulse(angularJacobianA, inertiaA, accumulatedImpulse, ref wsvA);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Solve(in Vector3Wide angularJacobianA, in BodyInertiaWide inertiaA, in Vector<Number> maximumImpulse, ref Vector<Number> accumulatedImpulse, ref BodyVelocityWide wsvA)
        {
            ...
            var inverseIsZero = Vector.Equals(Vector<Number>.Zero, angularA);
            var effectiveMass = Vector.ConditionalSelect(inverseIsZero, Vector<Number>.Zero, Vector<Number>.One / angularA);
