...
namespace BepuPhysics.Constraints
{
    ...
    public struct SwingLimit : ITwoBodyConstraintDescription<SwingLimit>
    {
        ...
        /// </summary>
        public Number MaximumSwingAngle { readonly get { return (Number)Math.Acos(MinimumDot); } set { MinimumDot = (Number)Math.Cos(value); } }
        ...
        public readonly void ApplyDescription(ref TypeBatch batch, int bundleIndex, int innerIndex)
        {
            ...
            Debug.Assert(MinimumDot >= Constants.Cm1 && MinimumDot <= Constants.C1, "SwingLimit.MinimumDot must be from -1 to 1 inclusive.");
    ...
    public struct SwingLimitPrestepData
    {
        ...
        public Vector<Number> MinimumDot;
        public SpringSettingsWide SpringSettings;
    }

    public struct SwingLimitFunctions : ITwoBodyConstraintFunctions<SwingLimitPrestepData, Vector<Number>>
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void ApplyImpulse(in Vector3Wide impulseToVelocityA, in Vector3Wide negatedImpulseToVelocityB, in Vector<Number> csi, ref Vector3Wide angularVelocityA, ref Vector3Wide angularVelocityB)
        {
        ...
        static void ComputeJacobian(in Vector3Wide axisLocalA, in Vector3Wide axisLocalB, in QuaternionWide orientationA, in QuaternionWide orientationB, out Vector3Wide axisA, out Vector3Wide axisB, out Vector3Wide jacobianA)
        {
            ...
            var useFallback = Vector.LessThan(jacobianLengthSquared, new Vector<Number>(Constants.C1em7));
            Vector3Wide.ConditionalSelect(useFallback, fallbackJacobian, jacobianA, out jacobianA);
        }
        public void WarmStart(in Vector3Wide positionA, in QuaternionWide orientationA, in BodyInertiaWide inertiaA, in Vector3Wide positionB, in QuaternionWide orientationB, in BodyInertiaWide inertiaB, ref SwingLimitPrestepData prestep, ref Vector<Number> accumulatedImpulses, ref BodyVelocityWide wsvA, ref BodyVelocityWide wsvB)
        {
        ...
        public void Solve(in Vector3Wide positionA, in QuaternionWide orientationA, in BodyInertiaWide inertiaA, in Vector3Wide positionB, in QuaternionWide orientationB, in BodyInertiaWide inertiaB, Number dt, Number inverseDt, ref SwingLimitPrestepData prestep, ref Vector<Number> accumulatedImpulses, ref BodyVelocityWide wsvA, ref BodyVelocityWide wsvB)
        {
            ...
            var biasVelocity = -Vector.Min(error * new Vector<Number>(inverseDt), error * positionErrorToVelocity);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void IncrementallyUpdateForSubstep(in Vector<Number> dt, in BodyVelocityWide wsvA, in BodyVelocityWide wsvB, ref SwingLimitPrestepData prestepData) { }
    }

    public class SwingLimitTypeProcessor : TwoBodyTypeProcessor<SwingLimitPrestepData, Vector<Number>, SwingLimitFunctions, AccessOnlyAngular, AccessOnlyAngular, AccessOnlyAngular, AccessOnlyAngular>
    {
