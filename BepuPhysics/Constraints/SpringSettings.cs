...
namespace BepuPhysics.Constraints
{
    public struct SpringSettingsWide
    {
        ...
        public Vector<Number> AngularFrequency;
        public Vector<Number> TwiceDampingRatio;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ComputeSpringiness(in SpringSettingsWide settings, Number dt,
            out Vector<Number> positionErrorToVelocity, out Vector<Number> effectiveMassCFMScale, out Vector<Number> softnessImpulseScale)
        {
            ...
            var angularFrequencyDt = settings.AngularFrequency * new Vector<Number>(dt);
            positionErrorToVelocity = settings.AngularFrequency / (angularFrequencyDt + settings.TwiceDampingRatio);
            var extra = Vector<Number>.One / (angularFrequencyDt * (angularFrequencyDt + settings.TwiceDampingRatio));
            effectiveMassCFMScale = Vector<Number>.One / (Vector<Number>.One + extra);
    ...
    public struct SpringSettings
    {
        ...
        /// </summary>
        public Number AngularFrequency;
        /// <summary>
        /// Twice the ratio of the spring's actual damping to its critical damping.
        /// </summary>
        public Number TwiceDampingRatio;

        /// <summary>
        /// Gets or sets the target number of undamped oscillations per unit of time.
        /// </summary>
        public Number Frequency { get { return AngularFrequency / MathHelper.TwoPi; } set { AngularFrequency = value * MathHelper.TwoPi; } }
        ...
        /// </summary>
        public Number DampingRatio { get { return TwiceDampingRatio / Constants.C2; } set { TwiceDampingRatio = value * 2; } }
        ...
        public SpringSettings(Number frequency, Number dampingRatio)
        {
