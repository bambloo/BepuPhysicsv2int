...
namespace BepuPhysics
{
    public partial class Bodies
    {
        ...
        {
            var pPositionX = (Number*)Unsafe.AsPointer(ref position.X);
            var pPositionY = (Number*)Unsafe.AsPointer(ref position.Y);
            var pPositionZ = (Number*)Unsafe.AsPointer(ref position.Z);
            var pOrientationX = (Number*)Unsafe.AsPointer(ref orientation.X);
            var pOrientationY = (Number*)Unsafe.AsPointer(ref orientation.Y);
            var pOrientationZ = (Number*)Unsafe.AsPointer(ref orientation.Z);
            var pOrientationW = (Number*)Unsafe.AsPointer(ref orientation.W);
            var pLinearX = (Number*)Unsafe.AsPointer(ref velocity.Linear.X);
            var pLinearY = (Number*)Unsafe.AsPointer(ref velocity.Linear.Y);
            var pLinearZ = (Number*)Unsafe.AsPointer(ref velocity.Linear.Z);
            var pAngularX = (Number*)Unsafe.AsPointer(ref velocity.Angular.X);
            var pAngularY = (Number*)Unsafe.AsPointer(ref velocity.Angular.Y);
            var pAngularZ = (Number*)Unsafe.AsPointer(ref velocity.Angular.Z);
            ...
            for (int i = 0; i < Vector<int>.Count; ++i)
            {
                ...
                if (encodedBodyIndex < 0)
                    continue;
                var stateValues = (Number*)(states + (encodedBodyIndex & BodyReferenceMask));
        ...
        {
            var pMass = (Number*)Unsafe.AsPointer(ref inertia.InverseMass);
            var pInertiaXX = (Number*)Unsafe.AsPointer(ref inertia.InverseInertiaTensor.XX);
            var pInertiaYX = (Number*)Unsafe.AsPointer(ref inertia.InverseInertiaTensor.YX);
            var pInertiaYY = (Number*)Unsafe.AsPointer(ref inertia.InverseInertiaTensor.YY);
            var pInertiaZX = (Number*)Unsafe.AsPointer(ref inertia.InverseInertiaTensor.ZX);
            var pInertiaZY = (Number*)Unsafe.AsPointer(ref inertia.InverseInertiaTensor.ZY);
            var pInertiaZZ = (Number*)Unsafe.AsPointer(ref inertia.InverseInertiaTensor.ZZ);
            ...
            for (int i = 0; i < Vector<int>.Count; ++i)
            {
                ...
                if (encodedBodyIndex < 0)
                    continue;
                var inertiaValues = (Number*)(states + (encodedBodyIndex & BodyReferenceMask)) + offsetInFloats;
        ...
        {
            Debug.Assert(states.Length > 0 && states.Length <= Vector<Number>.Count);
            ...
            //    var s0 = (Number*)states.Memory;
            //    var s1 = (Number*)(states.Memory + 1);
            //    var s2 = (Number*)(states.Memory + 2);
            //    var s3 = (Number*)(states.Memory + 3);
            //    var s4 = (Number*)(states.Memory + 4);
            //    var s5 = (Number*)(states.Memory + 5);
            //    var s6 = (Number*)(states.Memory + 6);
            //    var s7 = (Number*)(states.Memory + 7);
            ...
            //        var m1 = empty1 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s1);
            //        var m2 = empty2 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s2);
            //        var m3 = empty3 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s3);
            //        var m4 = empty4 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s4);
            //        var m5 = empty5 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s5);
            //        var m6 = empty6 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s6);
            //        var m7 = empty7 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s7);
            ...
            //        var m1 = empty1 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s1 + 8);
            //        var m2 = empty2 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s2 + 8);
            //        var m3 = empty3 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s3 + 8);
            //        var m4 = empty4 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s4 + 8);
            //        var m5 = empty5 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s5 + 8);
            //        var m6 = empty6 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s6 + 8);
            //        var m7 = empty7 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s7 + 8);
            ...
            where TAccessFilter : unmanaged, IBodyAccessFilter
        {
            ...
            //    var s0 = (Number*)(solverStates + (bodyIndices0 & BodyReferenceMask));
            //    var bodyIndices1 = encodedBodyIndices[1];
            //    var empty1 = bodyIndices1 < 0;
            //    var s1 = (Number*)(solverStates + (bodyIndices1 & BodyReferenceMask));
            //    var bodyIndices2 = encodedBodyIndices[2];
            //    var empty2 = bodyIndices2 < 0;
            //    var s2 = (Number*)(solverStates + (bodyIndices2 & BodyReferenceMask));
            //    var bodyIndices3 = encodedBodyIndices[3];
            //    var empty3 = bodyIndices3 < 0;
            //    var s3 = (Number*)(solverStates + (bodyIndices3 & BodyReferenceMask));
            //    var bodyIndices4 = encodedBodyIndices[4];
            //    var empty4 = bodyIndices4 < 0;
            //    var s4 = (Number*)(solverStates + (bodyIndices4 & BodyReferenceMask));
            //    var bodyIndices5 = encodedBodyIndices[5];
            //    var empty5 = bodyIndices5 < 0;
            //    var s5 = (Number*)(solverStates + (bodyIndices5 & BodyReferenceMask));
            //    var bodyIndices6 = encodedBodyIndices[6];
            //    var empty6 = bodyIndices6 < 0;
            //    var s6 = (Number*)(solverStates + (bodyIndices6 & BodyReferenceMask));
            //    var bodyIndices7 = encodedBodyIndices[7];
            //    var empty7 = bodyIndices7 < 0;
            //    var s7 = (Number*)(solverStates + (bodyIndices7 & BodyReferenceMask));
            ...
            //        //Load every body for the first half of the motion state.
            //        //Note that buffers are allocated on cache line boundaries, so we can use aligned loads for all that matters.
            //        var m0 = empty0 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s0);
            //        var m1 = empty1 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s1);
            //        var m2 = empty2 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s2);
            //        var m3 = empty3 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s3);
            //        var m4 = empty4 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s4);
            ...
            //    {
            //        //Second half.
            //        var m0 = empty0 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s0 + 8);
            //        var m1 = empty1 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s1 + 8);
            //        var m2 = empty2 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s2 + 8);
            //        var m3 = empty3 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s3 + 8);
            //        var m4 = empty4 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s4 + 8);
            ...
            //        var m0 = empty0 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s0 + offsetInFloats);
            //        var m1 = empty1 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s1 + offsetInFloats);
            //        var m2 = empty2 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s2 + offsetInFloats);
            //        var m3 = empty3 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s3 + offsetInFloats);
            //        var m4 = empty4 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s4 + offsetInFloats);
            //        var m5 = empty5 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s5 + offsetInFloats);
            //        var m6 = empty6 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s6 + offsetInFloats);
            //        var m7 = empty7 ? Vector256<Number>.Zero : Avx.LoadAlignedVector256(s7 + offsetInFloats);
            ...
            ref Vector3Wide position, ref QuaternionWide orientation, Vector<int> encodedBodyIndices, Vector<int> mask)
        {
            ...
            //        if (mask[0] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[0]), Avx.Permute2x128(o0, o1, 0 | (2 << 4)));
            //        if (mask[1] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[1]), Avx.Permute2x128(o4, o5, 0 | (2 << 4)));
            //        if (mask[2] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[2]), Avx.Permute2x128(o2, o3, 0 | (2 << 4)));
            //        if (mask[3] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[3]), Avx.Permute2x128(o6, o7, 0 | (2 << 4)));
            //        if (mask[4] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[4]), Avx.Permute2x128(o0, o1, 1 | (3 << 4)));
            //        if (mask[5] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[5]), Avx.Permute2x128(o4, o5, 1 | (3 << 4)));
            //        if (mask[6] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[6]), Avx.Permute2x128(o2, o3, 1 | (3 << 4)));
            //        if (mask[7] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[7]), Avx.Permute2x128(o6, o7, 1 | (3 << 4)));
            ...
            ref BodyInertiaWide inertia, Vector<int> encodedBodyIndices, Vector<int> mask)
        {
            ...
            //        if (mask[0] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[0]) + 24, Avx.Permute2x128(o0, o1, 0 | (2 << 4)));
            //        if (mask[1] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[1]) + 24, Avx.Permute2x128(o4, o5, 0 | (2 << 4)));
            //        if (mask[2] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[2]) + 24, Avx.Permute2x128(o2, o3, 0 | (2 << 4)));
            //        if (mask[3] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[3]) + 24, Avx.Permute2x128(o6, o7, 0 | (2 << 4)));
            //        if (mask[4] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[4]) + 24, Avx.Permute2x128(o0, o1, 1 | (3 << 4)));
            //        if (mask[5] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[5]) + 24, Avx.Permute2x128(o4, o5, 1 | (3 << 4)));
            //        if (mask[6] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[6]) + 24, Avx.Permute2x128(o2, o3, 1 | (3 << 4)));
            //        if (mask[7] != 0) Avx.StoreAligned((Number*)(states + encodedBodyIndices[7]) + 24, Avx.Permute2x128(o6, o7, 1 | (3 << 4)));
        ...
        public unsafe void ScatterVelocities<TAccessFilter>(ref BodyVelocityWide sourceVelocities, ref Vector<int> encodedBodyIndices) where TAccessFilter : unmanaged, IBodyAccessFilter
        {
            ...
            //        var states = ActiveSet.DynamicsState.Memory;
            //        if (indices[0] < DynamicLimit) Sse.StoreAligned((Number*)(states + indices[0]) + targetOffset, o0.GetLower());
            //        if (indices[1] < DynamicLimit) Sse.StoreAligned((Number*)(states + indices[1]) + targetOffset, o4.GetLower());
            //        if (indices[2] < DynamicLimit) Sse.StoreAligned((Number*)(states + indices[2]) + targetOffset, o2.GetLower());
            //        if (indices[3] < DynamicLimit) Sse.StoreAligned((Number*)(states + indices[3]) + targetOffset, o6.GetLower());
            //        if (indices[4] < DynamicLimit) Sse.StoreAligned((Number*)(states + indices[4]) + targetOffset, o0.GetUpper());
            //        if (indices[5] < DynamicLimit) Sse.StoreAligned((Number*)(states + indices[5]) + targetOffset, o4.GetUpper());
            //        if (indices[6] < DynamicLimit) Sse.StoreAligned((Number*)(states + indices[6]) + targetOffset, o2.GetUpper());
            //        if (indices[7] < DynamicLimit) Sse.StoreAligned((Number*)(states + indices[7]) + targetOffset, o6.GetUpper());
            ...
            //        var indices = (uint*)Unsafe.AsPointer(ref encodedBodyIndices);
            //        var states = ActiveSet.DynamicsState.Memory;
            //        if (indices[0] < DynamicLimit) Avx.StoreAligned((Number*)(states + indices[0]) + 8, Avx.Permute2x128(o0, o1, 0 | (2 << 4)));
            //        if (indices[1] < DynamicLimit) Avx.StoreAligned((Number*)(states + indices[1]) + 8, Avx.Permute2x128(o4, o5, 0 | (2 << 4)));
            //        if (indices[2] < DynamicLimit) Avx.StoreAligned((Number*)(states + indices[2]) + 8, Avx.Permute2x128(o2, o3, 0 | (2 << 4)));
            //        if (indices[3] < DynamicLimit) Avx.StoreAligned((Number*)(states + indices[3]) + 8, Avx.Permute2x128(o6, o7, 0 | (2 << 4)));
            //        if (indices[4] < DynamicLimit) Avx.StoreAligned((Number*)(states + indices[4]) + 8, Avx.Permute2x128(o0, o1, 1 | (3 << 4)));
            //        if (indices[5] < DynamicLimit) Avx.StoreAligned((Number*)(states + indices[5]) + 8, Avx.Permute2x128(o4, o5, 1 | (3 << 4)));
            //        if (indices[6] < DynamicLimit) Avx.StoreAligned((Number*)(states + indices[6]) + 8, Avx.Permute2x128(o2, o3, 1 | (3 << 4)));
            //        if (indices[7] < DynamicLimit) Avx.StoreAligned((Number*)(states + indices[7]) + 8, Avx.Permute2x128(o6, o7, 1 | (3 << 4)));
            //    }
