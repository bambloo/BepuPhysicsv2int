...
namespace BepuPhysics.Collidables
{
    ...
    public struct CollidableDescription
    {
        ...
        public Number MinimumSpeculativeMargin;
        /// <summary>
        /// Upper bound on the value of the speculative margin used by the collidable.
        /// </summary>
        /// <remarks><see cref="Number.MaxValue"/> tends to be a good default value for discrete or passive mode collidables. 
        ...
        /// </remarks>
        public Number MaximumSpeculativeMargin;
        ...
        public CollidableDescription(TypedIndex shape, Number minimumSpeculativeMargin, Number maximumSpeculativeMargin, ContinuousDetection continuity)
        {
            Shape = shape;
        ...
        /// <param name="minimumSpeculativeMargin">Lower bound on the value of the speculative margin used by the collidable.</param>
        /// <param name="maximumSpeculativeMargin">Upper bound on the value of the speculative margin used by the collidable.</param>
        public CollidableDescription(TypedIndex shape, Number minimumSpeculativeMargin, Number maximumSpeculativeMargin)
        {
            Shape = shape;
            MinimumSpeculativeMargin = minimumSpeculativeMargin;
            MaximumSpeculativeMargin = maximumSpeculativeMargin;
        ...
        /// <param name="maximumSpeculativeMargin">Upper bound on the value of the speculative margin used by the collidable.</param>
        /// <param name="continuity">Continuous collision detection settings for the collidable.</param>
        public CollidableDescription(TypedIndex shape, Number maximumSpeculativeMargin, ContinuousDetection continuity)
        {
            Shape = shape;
        ...
        /// <summary>
        /// Constructs a new collidable description. Uses 0 for the <see cref="MinimumSpeculativeMargin"/> and <see cref="Number.MaxValue"/> for the <see cref="MaximumSpeculativeMargin"/> .
        /// </summary>
        /// <param name="shape">Shape used by the collidable.</param>
        /// <param name="continuity">Continuous collision detection settings for the collidable.</param>
        public CollidableDescription(TypedIndex shape, ContinuousDetection continuity)
        {
            Shape = shape;
            MinimumSpeculativeMargin = 0;
            MaximumSpeculativeMargin = Number.MaxValue;
            Continuity = continuity;
        }

        /// <summary>
        /// Constructs a new collidable description with <see cref="ContinuousDetectionMode.Passive"/>. Will use a <see cref="MinimumSpeculativeMargin"/> of 0 and a <see cref="MaximumSpeculativeMargin"/> of <see cref="Number.MaxValue"/>.
        /// </summary>
        /// <param name="shape">Shape used by the collidable.</param>
        /// <remarks><see cref="ContinuousDetectionMode.Passive"/> and <see cref="ContinuousDetectionMode.Discrete"/> are equivalent in behavior when the <see cref="MaximumSpeculativeMargin"/>  is <see cref="Number.MaxValue"/> since they both result in the same (unbounded) expansion of body bounding boxes in response to velocity.</remarks>
        public CollidableDescription(TypedIndex shape) : this(shape, 0, Number.MaxValue, ContinuousDetection.Passive)
        {
        }
        ...
        public CollidableDescription(TypedIndex shape, Number maximumSpeculativeMargin) : this(shape, 0, maximumSpeculativeMargin, ContinuousDetection.Discrete)
        {
        }

        /// <summary>
        /// Constructs a new collidable description with <see cref="ContinuousDetectionMode.Passive"/>. Will use a minimum speculative margin of 0 and a maximum of <see cref="Number.MaxValue"/>.
        /// </summary>
