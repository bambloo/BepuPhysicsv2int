...
namespace BepuPhysics.Collidables
{
    ...
    public struct ContinuousDetection
    {
        ...
        /// </summary>
        public Number MinimumSweepTimestep;
        ...
        /// </summary>
        public Number SweepConvergenceThreshold;
        ...
        public static ContinuousDetection Continuous(Number minimumSweepTimestep, Number sweepConvergenceThreshold)
        {
            return new()
            {
        ...
        public static ContinuousDetection Continuous()
        {
            return Continuous(Constants.C1em3, Constants.C1em3);
        }
    }
