...
namespace Demos.Demos.Cars
{
    struct RaceTrack
    {
        public Number QuadrantRadius;
        public Vector2 Center;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetClosestPoint(in Vector2 point, Number laneOffset, out Vector2 closestPoint, out Vector2 flowDirection)
        {
            ...
            var toCircleEdgeDirection = distanceToQuadrantCenter > 0 ? quadrantCenterToPoint * (Constants.C1 / distanceToQuadrantCenter) : new Vector2(QuadrantRadius + signedLaneOffset, 0);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Number GetDistance(in Vector2 point)
        {
